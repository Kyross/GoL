...
public:
    ...
    QLabel *label_7;
    QPushButton *color_dead_pushButton;
    ...
    QPushButton *clear_mode_pushButton;
    QLabel *warning_mode_label;
    ...
    void setupUi(QDialog *ParametersDialog)
    {
        ...
        ParametersDialog->resize(404, 300);
        QIcon icon;
        ...
        clear_pushButton->setMaximumSize(QSize(25, 16777215));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/assets/i_clear.png"), QSize(), QIcon::Normal, QIcon::Off);
        clear_pushButton->setIcon(icon1);
        clear_pushButton->setAutoDefault(false);

        horizontalLayout_8->addWidget(clear_pushButton);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/assets/i_reset.png"), QSize(), QIcon::Normal, QIcon::Off);
        reset_universe_pushButton->setIcon(icon2);
        ...
        universe_spinBox->setMinimumSize(QSize(157, 0));
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/assets/i_reset_timer.png"), QSize(), QIcon::Normal, QIcon::Off);
        reset_timer_pushButton->setIcon(icon3);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/assets/i_reset_color.png"), QSize(), QIcon::Normal, QIcon::Off);
        reset_color_pushButton->setIcon(icon4);
        ...
        color_dead_pushButton = new QPushButton(tab);
        color_dead_pushButton->setObjectName(QString::fromUtf8("color_dead_pushButton"));
        color_dead_pushButton->setMinimumSize(QSize(157, 0));
        color_dead_pushButton->setMaximumSize(QSize(157, 16));
        color_dead_pushButton->setFocusPolicy(Qt::NoFocus);
        color_dead_pushButton->setIconSize(QSize(175, 16));
        color_dead_pushButton->setAutoDefault(false);
        color_dead_pushButton->setFlat(true);

        horizontalLayout_9->addWidget(color_dead_pushButton);
        ...
        clear_mode_pushButton = new QPushButton(tab_2);
        clear_mode_pushButton->setObjectName(QString::fromUtf8("clear_mode_pushButton"));
        clear_mode_pushButton->setMaximumSize(QSize(25, 16777215));
        clear_mode_pushButton->setIcon(icon1);
        clear_mode_pushButton->setAutoDefault(false);

        horizontalLayout_2->addWidget(clear_mode_pushButton);

        warning_mode_label = new QLabel(tab_2);
        warning_mode_label->setObjectName(QString::fromUtf8("warning_mode_label"));

        horizontalLayout_2->addWidget(warning_mode_label);
    ...
    void retranslateUi(QDialog *ParametersDialog)
    {
        ...
        label_7->setText(QApplication::translate("ParametersDialog", "Relative dead body color", nullptr));
        color_dead_pushButton->setText(QString());
...
#endif // QT_NO_TOOLTIP
        dead_checkBox->setText(QApplication::translate("ParametersDialog", "Dead body", nullptr));
        clear_mode_pushButton->setText(QString());
        warning_mode_label->setText(QApplication::translate("ParametersDialog", "<html><head/><body><p><span style=\" color:#ff0000;\">Game must be clear before</span></p></body></html>", nullptr));
