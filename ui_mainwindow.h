...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        universe_spinBox->setMinimum(10);
        universe_spinBox->setMaximum(400);
        universe_spinBox->setValue(50);
        ...
        universe_slider->setMinimum(10);
        universe_slider->setMaximum(400);
        universe_slider->setValue(50);
        ...
        timer_SpinBox->setMinimum(1);
        timer_SpinBox->setMaximum(500);
        timer_SpinBox->setValue(200);
